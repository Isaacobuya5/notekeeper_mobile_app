...
public class NoteCreationTest {
    ...
    @Rule // informs JUnit of our Activity test rule
    ...
    // first we need to get reference to the view interaction
    // first interaction involves clicking the floating action button to create a new note
//        ViewInteraction fabNewNote = onView(withId(R.id.fab));
//     // performing an action on that view
//     fabNewNote.perform(click());
// above can be replaced with a single line as follows
    ...
    // testing UI logic - ensure the new note was saved
        // index of the last note
